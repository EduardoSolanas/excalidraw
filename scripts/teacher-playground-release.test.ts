...
describe("teacher-playground Excalidraw release", () => {
  ...
  it("targets the next immutable Teacher Playground release", async () => {
    ...
    expect(packageJson.version).toBe("0.18.1-tp.10");
    expect(documentation).toContain("teacher-playground-v0.18.1-tp.10");
    ...
    expect(workflow).toContain(
      'description: "Teacher Playground version to upload (for example 0.18.1-tp.10)"',
    );
