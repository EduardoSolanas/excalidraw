...
GitHub Actions run `35917185046` completed successfully: the validation, GitHub Release, and `publish-r2` jobs all passed for `0.18.1-tp.12`. `latest.json` currently points to 0.18.1-tp.12, and the public `package.tgz` is 9,452,070 bytes. The release manifest has zero paths matching zh-CN, zh-HK, zh-TW, or Xiaolai; Japanese and Korean assets are retained.
...
```text
teacher-playground-v0.18.1-tp.12
```

The current build is tagged `teacher-playground-v0.18.1-tp.12`.
